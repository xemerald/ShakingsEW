...
#--------------------------------------------------------------------------
 ...
 Ring   LIST_RING        1001    # public list info exchange space
 Ring   RWAVE_RING       1002    # public real value waveform data for EEW system
 Ring   XWAVE_RING       1003    # public real value waveform data for EEW system
 Ring   PICK_RING        1005    # public parametric data
 Ring   PEAK_RING        1006    # public peak value data for EEW system
 Ring   HYPO_RING        1015    # public hypocenters etc.
 Ring   TRIG_RING        1016    # public trigger list data
 Ring   GMAP_RING        1017    # public grid map data

 Ring   RPALERT_RING     1021    # private raw packet from palert for analysis
...
#--------------------------------------------------------------------------
 ...
 Module   MOD_POSTSHAKE         3
 Module   MOD_SHAKEMAP          4
 Module   MOD_SHAKEMAPV         5
 Module   MOD_SHAKEMAPSA        6
 Module   MOD_SHAKEALERT        7
 Module   MOD_CF2TRACE          10
 Module   MOD_TRACE2PEAK        11
 Module   MOD_TRACE2PEAKX       12
 Module   MOD_PEAK2TRIG         13
 Module   MOD_DIF2TRACE         14
 Module   MOD_SHAKE2WS          15
 Module   MOD_RESPECTRA         16
...
# Installation-specific message-type mappings (100-255):
 ...
 Message  TYPE_TRACEPEAK     126
 Message  TYPE_TRIGLIST      127
 Message  TYPE_GRIDMAP       128
